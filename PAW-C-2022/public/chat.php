...
function loginForm()
{
    ...
    <div id="loginform">
    <p class= "text-xl" >Masukkan nama anda!</p>
    <form action="chat.php" class="w-full" method="post">
      <label for="name" class="text-2xl">Nama </label>
      <input type="text" name="name" id="name" class="input text-white input-bordered input-warning " />
